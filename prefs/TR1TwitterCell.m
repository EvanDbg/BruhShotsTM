...
//		based on Cephei Framework and taken from Kritanta
//
// Apache 2.0 License for code used in TR1PrefsLicense located in preference bundle
//


#import "TR1TwitterCell.h"
#import <Preferences/PSSpecifier.h>
#import <UIKit/UIImage+Private.h>
#import <Foundation/Foundation.h>

@interface TR1LinkCell ()

- (BOOL)shouldShowAvatar;

@end

@interface TR1TwitterCell () {
	NSString *_user;
}

@end

@implementation TR1TwitterCell
...
- (void)loadAvatarIfNeeded {
	...
	// TODO: fix this
	self.avatarImage = [UIImage imageNamed:[NSString stringWithFormat:@"/Library/PreferenceBundles/bruhshotsprefs.bundle/%@.png", @"FectaTr1"]];
	/*
